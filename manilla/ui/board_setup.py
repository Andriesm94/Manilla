...
class BoardSetupApp(tk.Frame):
    ...
    def _draw_pirate_boat(self) -> None:
        ...
        # decision instead of only its outcome. Plunder-only, per the
        # user: the free mid-voyage boarding bonus is excluded from every
        # wealth/REV calculation (see wealth.pirate_slot_ev_if_taken_now),
